...
const getAllMovies = async () => {
    try {
      return await axios.get(`${BASE_URL}/movie/popular?api_key=${API_KEY}&language=en-US&page=1`) ;
    } catch (error) {
      console.error('Error geting all movies', error);
      return null;
    }
  };
...
export { searchMovies, getRandomMovie, getAllMovies };
